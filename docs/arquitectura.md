...
Una simulación opcional (`run_simulation`) actualiza lecturas de nivel y temperatura cada 1 Hz para emular sensores físicos.
...
- Lee el último `TankState`, aplica incrementos/decrementos en nivel y temperatura en función de las salidas (válvula/resistencia) y vuelve a invocar `ControlService.step()`.
