# Documentación del proyecto Termocuplas

Este directorio concentra la documentación funcional y técnica del sistema. Los archivos disponibles son:

- `arquitectura.md`: visión de alto nivel, modelo de datos y diagrama de interacción entre componentes.
- `user-manual.md`: guía paso a paso para operadores y testers (instalación, uso del dashboard y simulación).
